		...
		return (
			<div class='tree'>
				<div class='tree-config'>
					<button class='tree-config__button tree-config__button--expand js-tree-expand' title='Expand All'>
						<svg
...
const addToCategory = (category: ICategory, item: DeclarationReflection, titleSplit: string[], idx: number): void => {
