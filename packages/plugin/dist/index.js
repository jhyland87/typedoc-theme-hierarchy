...
import { JSX, ReflectionKind, translateTagName } from "typedoc";
...
var commentTags = (context) => (props) => {
  ...
  const tags = props.kindOf(ReflectionKind.SomeSignature) ? comment.blockTags.filter(
  ...
  return /* @__PURE__ */ JSX.createElement(JSX.Fragment, null, beforeTags, /* @__PURE__ */ JSX.createElement("div", { class: "tsd-comment tsd-typography" }, tags.map((item) => {
    const name = item.name ? `${translateTagName(item.tag)}: ${item.name}` : translateTagName(item.tag);
    const anchor = context.slugger.slug(name);
    const body = /* @__PURE__ */ JSX.createElement(JSX.Raw, { html: context.markdown(item.content) });
    if (COLLAPSIBLE_TAGS.has(item.tag)) {
      return /* @__PURE__ */ JSX.createElement("details", { class: `tsd-tag-${item.tag.substring(1)} tsd-tag--collapsible`, id: anchor }, /* @__PURE__ */ JSX.createElement("summary", { class: "tsd-tag__summary" }, /* @__PURE__ */ JSX.createElement("h4", { class: "tsd-anchor-link" }, name)), /* @__PURE__ */ JSX.createElement("div", { class: "tsd-tag--collapsible__content" }, body));
    }
    return /* @__PURE__ */ JSX.createElement("div", { class: `tsd-tag-${item.tag.substring(1)}` }, /* @__PURE__ */ JSX.createElement("h4", { class: "tsd-anchor-link", id: anchor }, name), body);
  })), afterTags);
};
...
import {
  JSX as JSX2,
  ReflectionKind as ReflectionKind2
} from "typedoc";
var navigation = (context) => (props) => {
  ...
  return /* @__PURE__ */ JSX2.createElement("div", { class: "tree" }, /* @__PURE__ */ JSX2.createElement("div", { class: "tree-config" }, /* @__PURE__ */ JSX2.createElement("button", { class: "tree-config__button tree-config__button--expand js-tree-expand", title: "Expand All" }, /* @__PURE__ */ JSX2.createElement(
    "svg",
    {
    ...
    /* @__PURE__ */ JSX2.createElement("svg", { viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", fill: "currentColor" }, /* @__PURE__ */ JSX2.createElement("circle", { cx: "12", cy: "12", r: "3" }), /* @__PURE__ */ JSX2.createElement("path", { d: "M13 4.069V2h-2v2.069A8.008 8.008 0 0 0 4.069 11H2v2h2.069A8.007 8.007 0 0 0 11 19.931V22h2v-2.069A8.007 8.007 0 0 0 19.931 13H22v-2h-2.069A8.008 8.008 0 0 0 13 4.069zM12 18c-3.309 0-6-2.691-6-6s2.691-6 6-6 6 2.691 6 6-2.691 6-6 6z" }))
  )), /* @__PURE__ */ JSX2.createElement("div", { class: "tree-content" }, /* @__PURE__ */ JSX2.createElement(Navigation, { ...categories, documents, context })));
};
...
var DocCategoryNavigation = ({
  ...
  items,
  context
}) => /* @__PURE__ */ JSX2.createElement("ul", { class: "js-category-list category", "data-id": id }, Object.entries(categories).map(([key, item]) => /* @__PURE__ */ JSX2.createElement("li", null, /* @__PURE__ */ JSX2.createElement("span", { class: "js-category-title category__title", "data-id": item.id }, /* @__PURE__ */ JSX2.createElement("div", { class: "category__folder", "data-id": item.id }), key), /* @__PURE__ */ JSX2.createElement(DocCategoryNavigation, { id: item.id, categories: item.categories, items: item.items, context }))), items.map((doc) => /* @__PURE__ */ JSX2.createElement("li", null, /* @__PURE__ */ JSX2.createElement(DocumentItem, { doc, context }))));
var DocumentItem = ({
  doc,
  context
}) => {
  const displayName = doc.name.includes(`/`) ? doc.name.split(`/`).pop() || doc.name : doc.name;
  return /* @__PURE__ */ JSX2.createElement(JSX2.Fragment, null, /* @__PURE__ */ JSX2.createElement(
    "a",
    {
    ...
    displayName
  ), doc.children && doc.children.length > 0 && /* @__PURE__ */ JSX2.createElement("ul", null, doc.children.map((child) => /* @__PURE__ */ JSX2.createElement("li", null, /* @__PURE__ */ JSX2.createElement(DocumentItem, { doc: child, context })))));
};
var Navigation = ({
  id,
  categories,
  ...
  return /* @__PURE__ */ JSX2.createElement("ul", { class: "js-category-list category", "data-id": id }, docTree && /* @__PURE__ */ JSX2.createElement("li", null, /* @__PURE__ */ JSX2.createElement("span", { class: "js-category-title category__title", "data-id": "docs-root" }, /* @__PURE__ */ JSX2.createElement("div", { class: "category__folder", "data-id": "docs-root" }), "Documents"), /* @__PURE__ */ JSX2.createElement(DocCategoryNavigation, { ...docTree, context })), Object.entries(categories).map(([key, item]) => /* @__PURE__ */ JSX2.createElement("li", null, /* @__PURE__ */ JSX2.createElement("span", { class: "js-category-title category__title", "data-id": item.id }, /* @__PURE__ */ JSX2.createElement("div", { class: "category__folder", "data-id": item.id }), key), /* @__PURE__ */ JSX2.createElement(Navigation, { id: item.id, categories: item.categories, items: item.items, context }))), items.map((item) => /* @__PURE__ */ JSX2.createElement("li", null, /* @__PURE__ */ JSX2.createElement(Item, { item, context }))));
};
...
var Item = ({ item, context }) => {
  if (`id` in item) {
    ...
    return /* @__PURE__ */ JSX2.createElement(JSX2.Fragment, null, /* @__PURE__ */ JSX2.createElement(
      ...
      item.title
    ), /* @__PURE__ */ JSX2.createElement("ul", null, item.children?.map((subItem) => /* @__PURE__ */ JSX2.createElement("li", null, /* @__PURE__ */ JSX2.createElement(
      "a",
      {
  ...
  return /* @__PURE__ */ JSX2.createElement(JSX2.Fragment, null, /* @__PURE__ */ JSX2.createElement("span", { class: `category__link category__link--disable js-category-link category__link--ts${item.children.length > 0 && item.children.every((child) => child.isDeprecated()) ? ` category__link--deprecated` : ``}` }, item.title), /* @__PURE__ */ JSX2.createElement("ul", null, item.children.map((subItem) => /* @__PURE__ */ JSX2.createElement("li", null, /* @__PURE__ */ JSX2.createElement(
    "a",
    {
      class: `category__link js-category-link${subItem.isDeprecated() ? ` category__link--deprecated` : ``}`,
      href: context.urlTo(subItem),
...
var addToCategory = (category, item, titleSplit, idx) => {
  if (idx === titleSplit.length - 1) {
    if (item.kind === ReflectionKind2.Module) {
...
var load = (app) => {
  app.renderer.hooks.on(
    `head.end`,
    (context) => /* @__PURE__ */ JSX3.createElement("link", { rel: "stylesheet", href: context.relativeURL(`assets/hierarchy.css`) })
  );
  app.renderer.hooks.on(
    `body.end`,
    (context) => /* @__PURE__ */ JSX3.createElement("script", { src: context.relativeURL(`assets/hierarchy-theme.js`) })
  );
