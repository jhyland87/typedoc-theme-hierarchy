...
var navigation = (context) => (props) => {
  ...
  )), /* @__PURE__ */ JSX.createElement("div", { class: "tree-content" }, /* @__PURE__ */ JSX.createElement(Navigation, { ...categories, documents, context })));
};
...
var DocumentItem = ({
  ...
  return /* @__PURE__ */ JSX.createElement(JSX.Fragment, null, /* @__PURE__ */ JSX.createElement(
    ...
    displayName
  ), doc.children && doc.children.length > 0 && /* @__PURE__ */ JSX.createElement("ul", null, doc.children.map((child) => /* @__PURE__ */ JSX.createElement("li", null, /* @__PURE__ */ JSX.createElement(DocumentItem, { doc: child, context })))));
};
var Navigation = ({
  id,
  categories,
  ...
  return /* @__PURE__ */ JSX.createElement("ul", { class: "js-category-list category", "data-id": id }, docTree && /* @__PURE__ */ JSX.createElement("li", null, /* @__PURE__ */ JSX.createElement("span", { class: "js-category-title category__title", "data-id": "docs-root" }, /* @__PURE__ */ JSX.createElement("div", { class: "category__folder", "data-id": "docs-root" }), "Documents"), /* @__PURE__ */ JSX.createElement(DocCategoryNavigation, { ...docTree, context })), Object.entries(categories).map(([key, item]) => /* @__PURE__ */ JSX.createElement("li", null, /* @__PURE__ */ JSX.createElement("span", { class: "js-category-title category__title", "data-id": item.id }, /* @__PURE__ */ JSX.createElement("div", { class: "category__folder", "data-id": item.id }), key), /* @__PURE__ */ JSX.createElement(Navigation, { id: item.id, categories: item.categories, items: item.items, context }))), items.map((item) => /* @__PURE__ */ JSX.createElement("li", null, /* @__PURE__ */ JSX.createElement(Item, { item, context }))));
};
