...
var navigation = (context) => (props) => {
  ...
  )), /* @__PURE__ */ import_typedoc.JSX.createElement("div", { class: "tree-content" }, /* @__PURE__ */ import_typedoc.JSX.createElement(Navigation, { ...categories, documents, context })));
};
...
var DocumentItem = ({
  ...
  return /* @__PURE__ */ import_typedoc.JSX.createElement(import_typedoc.JSX.Fragment, null, /* @__PURE__ */ import_typedoc.JSX.createElement(
    ...
    displayName
  ), doc.children && doc.children.length > 0 && /* @__PURE__ */ import_typedoc.JSX.createElement("ul", null, doc.children.map((child) => /* @__PURE__ */ import_typedoc.JSX.createElement("li", null, /* @__PURE__ */ import_typedoc.JSX.createElement(DocumentItem, { doc: child, context })))));
};
var Navigation = ({
  id,
  categories,
